...
const paymentData = [
  { id: '1', doctorName: 'Dr. Ayesha Khan', patients: 10, rate: 500, date: '2025-04-10' },
  { id: '2', doctorName: 'Dr. Rohan Mehta', patients: 5, rate: 500, date: '2025-04-11' },
  { id: '3', doctorName: 'Dr. Nidhi Verma', patients: 8, rate: 500, date: '2025-04-10' },
  { id: '4', doctorName: 'Dr. Swati Patel', patients: 12, rate: 500, date: '2025-04-09' },
  { id: '5', doctorName: 'Dr. Karan Bhatt', patients: 6, rate: 500, date: '2025-04-10' },
  { id: '6', doctorName: 'Dr. Isha Kapoor', patients: 7, rate: 500, date: '2025-04-11' },
  { id: '7', doctorName: 'Dr. Pratik Shah', patients: 4, rate: 500, date: '2025-04-10' },
];
...
const PaymentTrackingScreen = () => {
  ...
  const renderItem = ({ item }) => {
    const payableAmount = item.patients * item.rate;
    return (
