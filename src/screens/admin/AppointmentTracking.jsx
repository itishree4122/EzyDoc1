...
export default function AppointmentTracking() {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      <Text style={[styles.cell, styles.doctor]}>{item.doctorName}</Text>
