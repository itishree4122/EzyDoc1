...
const LabSchedule = ({ navigation }) => {
  ...
  <TouchableOpacity style={styles.editIconContainer} onPress={() => handleEdit(item)}>
    <Image
  ...
  <TouchableOpacity style={styles.deleteIconContainer} onPress={() => handleDelete(item.id)}>
    <Image
  ...
  <Text style={styles.appointmentText}>Time: {item.start_time} - {item.end_time}</Text>
</View>
